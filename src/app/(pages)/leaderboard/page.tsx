...
const Page = () => {
  ...
  const handleMint = () => {
    ...
    switch (userIndex) {
      case 0:
        mintAmount = 500000000000;
        break;
      case 1:
        mintAmount = 300000000000;
        break;
      case 2:
        mintAmount = 150000000000;
        break;
      default:
        return;
    }
  ...
  return (
    <div className="flex max-h-screen w-full flex-col px-2">
      <h1 className="mt-[-50px] text-center text-2xl font-bold">Leaderboard</h1>
      <div className="w-full overflow-hidden rounded-xl bg-[#00000075] p-2 shadow-2xl">
            ...
            usersList
              ...
              .map((user, index) => {
                ...
                return (
                  <div
                    key={user.name}
                    className={`flex w-full items-center justify-between p-1 px-2 ${classNames} max-h-[80%]`}
                  >
      ...
      {isTopThree && <Button content="Mint" onClick={handleMint} />}
    </div>
  );
};
